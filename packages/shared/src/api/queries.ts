...
export const pokemonKeys = {
  ...
  overview: () => [...pokemonKeys.all, 'overview'] as const,
...
export function usePokedexOverview() {
  return useQuery({
    queryKey: pokemonKeys.overview(),
    queryFn: ({ signal }) => fetchPokedexOverview(signal),
    staleTime: Infinity,
  })
}
